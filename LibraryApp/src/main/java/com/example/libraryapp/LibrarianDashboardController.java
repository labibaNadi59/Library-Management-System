...
public class LibrarianDashboardController {
    ...
    @FXML
    private void openAddNewMember() throws IOException {
        Stage stage = new Stage();
        FXMLLoader loader = new FXMLLoader(getClass().getResource("add_new_member.fxml"));
    ...
    @FXML
    private void openSearchByItemId() throws IOException {
        Stage stage = new Stage();
    ...
    @FXML
    private void openSearchByTitleAuthor() throws IOException {
        Stage stage = new Stage();
    ...
    @FXML
    private void onCheckInItem() throws IOException {
        Stage stage = new Stage();
        FXMLLoader loader = new FXMLLoader(getClass().getResource("check_in_item.fxml"));
        stage.setScene(new Scene(loader.load()));
        stage.setTitle("Check In Item");
        stage.show();
    }
    ...
    @FXML
    private void onAddNewBook() throws IOException {
        Stage stage = new Stage();
        FXMLLoader loader = new FXMLLoader(getClass().getResource("add_new_book.fxml"));
        stage.setScene(new Scene(loader.load()));
    ...
    @FXML
    private void onAddNewPublication() throws IOException {
        Stage stage = new Stage();
        FXMLLoader loader = new FXMLLoader(getClass().getResource("add_new_publication.fxml"));
        stage.setScene(new Scene(loader.load()));
        stage.setTitle("Add New Publication");
        stage.show();
    }
    @FXML
